...
public class WkButton1 {
    ...
    public WkButton1(JFXButton button, Integer row, Integer column, IstSoll istSoll) {
        this.button = button;
        this.row = row;
        this.column = column;
    ...
    public boolean equals(Object obj) {
        ...
        final WkButton1 other = (WkButton1) obj;
